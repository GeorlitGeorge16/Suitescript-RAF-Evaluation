...
define(['N/record', 'N/search', 'N/log'],
    ...
    function (record, search, log, currentRecord) {
        ...
        function amountCalculate(record, field)
        {
            try
            {
                if(field === 'custpage_jj_amount')
                {
                    let quantity= record.getValue('custpage_jj_quantity');
                    let price= record.getValue('custpage_jj_price');
            ...
            {
                log.debug({
                    title: 'Error in Calulating amount',
                    details: e.stack
                });
            }
        }
